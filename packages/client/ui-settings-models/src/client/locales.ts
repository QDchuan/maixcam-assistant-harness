...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  creating: '创建中\u2026',
  welcomeTitle: '关于这个助手',
  welcomeBody: '这是面向 MaixCAM / MaixPy 的开发助手。它把 MaixPy 的教程与 API 文档建成本地知识库，回答时先检索、再作答，并逐条给出来源。\n\n它不猜 API 名字：写进代码的每个符号都会先对过官方名单。本地知识库没有覆盖到的部分，它会直接说不知道 —— 这是它存在的理由，请把它当作一个「会告诉你哪里没查到」的助手，而不是一个什么都能答的模型。\n\n知识库来自公开的 MaixPy 文档，模型与底座来自 DeepSeek Harness（MIT）。',
  welcomeContinue: '开始使用',
